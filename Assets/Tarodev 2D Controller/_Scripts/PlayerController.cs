...
namespace TarodevController
{
    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        private IEnumerator RespawnRoutine()
        {
            ...
            float fadeInOffset = 1.0f; // Intervallo di tempo prima della fine del suono per iniziare il fade-in
             float fadeInDuration = 0.6f; // Durata del fade-in dell'immagine di respawn
            float fadeOutDuration = 0.4f; // Durata del fade-out dell'immagine di respawn
